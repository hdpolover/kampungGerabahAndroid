...
public class ProdukCelenganAdapter extends RecyclerView.Adapter<ProdukCelenganAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukCelenganAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukCelenganAdapter.list = list;
