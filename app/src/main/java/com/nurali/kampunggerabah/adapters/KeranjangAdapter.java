...
import com.nurali.kampunggerabah.activities.CustomerKeranjangActivity;
import com.nurali.kampunggerabah.activities.PengrajinDetailActivity;
import com.nurali.kampunggerabah.activities.ProdukCekoutActivity;
...
public class KeranjangAdapter extends RecyclerView.Adapter<KeranjangAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.beliBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(context, ProdukCekoutActivity.class);
