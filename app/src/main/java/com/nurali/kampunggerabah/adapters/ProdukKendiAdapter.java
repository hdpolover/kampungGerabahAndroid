...
public class ProdukKendiAdapter extends RecyclerView.Adapter<ProdukKendiAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukKendiAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukKendiAdapter.list = list;
