...
public class ProdukLampionAdapter extends RecyclerView.Adapter<ProdukLampionAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukLampionAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukLampionAdapter.list = list;
