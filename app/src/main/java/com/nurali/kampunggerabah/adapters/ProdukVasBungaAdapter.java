...
public class ProdukVasBungaAdapter extends RecyclerView.Adapter<ProdukVasBungaAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukVasBungaAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukVasBungaAdapter.list = list;
