...
public class ProdukCobekAdapter extends RecyclerView.Adapter<ProdukCobekAdapter.ViewHolder> {
    private static List<ProdukResponse.ProdukModel> list;
    Context context;

    public ProdukCobekAdapter(List<ProdukResponse.ProdukModel> list, Context context) {
        ProdukCobekAdapter.list = list;
