...
public class CelenganProdukFragment extends Fragment {
    ...
    String kategori = "celengan";

    LinearLayout noData;

    public CelenganProdukFragment() {
        // Required empty public constructor
    }

    public static CelenganProdukFragment newInstance(String param1, String param2) {
        CelenganProdukFragment fragment = new CelenganProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_container_celengan, container, false);
