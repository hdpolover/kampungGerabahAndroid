...
import com.nurali.kampunggerabah.adapters.ProdukLampionAdapter;
...
public class LampionProdukFragment extends Fragment {
    ...
    String kategori = "lampion";
    LinearLayout noData;

    public LampionProdukFragment() {
        // Required empty public constructor
    }

    public static LampionProdukFragment newInstance(String param1, String param2) {
        LampionProdukFragment fragment = new LampionProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_container_lampion, container, false);
            ...
            apiInterface.getKategoriProdukCustomer(kategori).enqueue(new Callback<ProdukResponse>() {
                ...
                public void onResponse(Call<ProdukResponse> call, Response<ProdukResponse> response) {
                    if (response.body().status) {
                        ...
                        rv.setAdapter(new ProdukLampionAdapter(list, getContext()));
