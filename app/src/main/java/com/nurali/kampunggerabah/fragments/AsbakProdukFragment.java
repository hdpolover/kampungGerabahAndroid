...
public class AsbakProdukFragment extends Fragment {
    ...
    String kategori = "asbak";

    LinearLayout noData;

    public AsbakProdukFragment() {
        // Required empty public constructor
    }

    public static AsbakProdukFragment newInstance(String param1, String param2) {
        AsbakProdukFragment fragment = new AsbakProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_container_asbak, container, false);
