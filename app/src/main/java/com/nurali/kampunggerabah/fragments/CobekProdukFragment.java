...
import com.nurali.kampunggerabah.adapters.ProdukCobekAdapter;
...
public class CobekProdukFragment extends Fragment {
    ...
    public CobekProdukFragment() {
        // Required empty public constructor
    }

    public static CobekProdukFragment newInstance(String param1, String param2) {
        CobekProdukFragment fragment = new CobekProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_container_cobek, container, false);
            ...
            apiInterface.getKategoriProdukCustomer(kategori).enqueue(new Callback<ProdukResponse>() {
                ...
                public void onResponse(Call<ProdukResponse> call, Response<ProdukResponse> response) {
                    if (response.body().status) {
                        ...
                        rv.setAdapter(new ProdukCobekAdapter(list, getContext()));
