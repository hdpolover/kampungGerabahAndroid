...
import com.nurali.kampunggerabah.adapters.ProdukVasBungaAdapter;
...
public class VasBungaProdukFragment extends Fragment {
    ...
    String kategori = "vas bunga";
    LinearLayout noData;

    public VasBungaProdukFragment() {
        // Required empty public constructor
    }

    public static VasBungaProdukFragment newInstance(String param1, String param2) {
        VasBungaProdukFragment fragment = new VasBungaProdukFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_container_vas, container, false);
            ...
            apiInterface.getKategoriProdukCustomer(kategori).enqueue(new Callback<ProdukResponse>() {
                ...
                public void onResponse(Call<ProdukResponse> call, Response<ProdukResponse> response) {
                    if (response.body().status) {
                        ...
                        rv.setAdapter(new ProdukVasBungaAdapter(list, getContext()));
